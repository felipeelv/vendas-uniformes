...
export default function SuccessScreen({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white flex items-center justify-center p-4 font-sans">
      <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-xl shadow-emerald-100/50 border border-emerald-100 max-w-md w-full text-center">
        {/* Animated icon */}
        <div className="relative w-24 h-24 mx-auto mb-6">
          <div className="absolute inset-0 bg-emerald-100 rounded-full animate-ping opacity-20" />
          <div className="relative w-24 h-24 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center">
        ...
        <div className="bg-slate-50 rounded-xl p-4 mb-6 text-left space-y-2">
          ...
          <div className="flex justify-between text-sm border-t border-slate-200 pt-2 mt-2">
            ...
            <span className="font-black text-emerald-600">{formatBRL(totalVenda)}</span>
          </div>
        </div>

        <button
          onClick={onWhatsApp}
          className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-200 mb-3 transition-all hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center gap-2 text-base"
        >
